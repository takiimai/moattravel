...
public class ReservationController {
	...
	public ReservationController(ReservationRepository reservationRepository, HouseRepository houseRepository,
			ReservationService reservatonService, UserRepository userRepository) {
		this.reservationRepository = reservationRepository;
		this.houseRepository = houseRepository;
		this.reservationService = reservatonService;
	}
	...
	public String confirm(@PathVariable(name = "id") Integer id,
		...
		ReservationRegisterForm reservationRegisterForm = new ReservationRegisterForm(house.getId(), user.getId(),
				checkinDate.toString(), checkoutDate.toString(), reservationInputForm.getNumberOfPeople(), reservationService.calculateAmount(checkinDate,checkoutDate,house.getPrice()));
		model.addAttribute("house", house);
	...
	public String create(@ModelAttribute ReservationRegisterForm reservationRegisterForm) {
		...
		return "redirect:/reservations?reserverd";
	}
}
